...
<head>
    ...
    <!-- Template para quando houver um telefone já vinculado ao Aluno -->
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <form method="POST" action="../controller/updateAluno.php">
                    <?php foreach($manager->consultaInfo($id) as $aluno_info) : ?>
                    <div class="form-group">
                        <label for="nome">Nome</label>
                        <input type="text" class="form-control" id="nome" name="nome" value="<?=$aluno_info['nome']?>" placeholder="Digite um nome" required>
                    </div>
                    <div class="form-group">
                        <label for="cpf">CPF</label>
                        <input type="text" class="form-control" id="cpf" name="cpf" value="<?=$aluno_info['cpf']?>" placeholder="Digite um CPF" disabled>
                    </div>
                    <div class="form-group">
                        <label for="curso">Curso</label>
                        <select type="text" class="form-control" id="curso" name="curso" required>
                            <?php foreach ($manager->listaCursos() as $curso) : 
                                    $cursoAtual = $aluno_info['id_curso'] == $curso['id_curso'];
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="<?=$aluno_info['email']?>" aria-describedby="emailHelp"
                    ...
                    <div class="form-group">
                        ...
                        <?php $flg_prof = $aluno_info['flg_prof'] ? 'checked="checked"' : ''; ?>
                        <input type="checkbox" id="flgProf" name="flgProf" value="true" <?=$flg_prof?>>
                    </div>
                    <div class="form-group" id="showTitulo">
                        ...
                        <select type="text" class="form-control" id="titulo" name="titulo">
                            ...
                            <?php foreach ($manager->listaTitulos() as $titulo) : 
                                $tituloAtual = $aluno_info['id_titulo'] == $titulo['id_titulo'];
                        ...
                        <div class="col-2 text-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <?php if($aluno_info['telefone']){?>
                                        <a id="showTel" class="dropdown-item editaTel" href="#" style="display:none"><?=$aluno_info['tipo_tel']?></a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
