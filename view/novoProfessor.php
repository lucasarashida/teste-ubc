...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <form method="POST" action="../controller/insertProfessor.php">
                    ...
                    <div class="form-group">
                        <label for="flgProf">Também sou Aluno</label>
                        <input type="checkbox" id="flgAluno" name="flgAluno" value="true">
                    </div>
